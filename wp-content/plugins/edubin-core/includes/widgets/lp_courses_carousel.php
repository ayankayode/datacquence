    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .edubin-single-course-1 .course-bottom .name .ins-name a, .edubin-single-course-2>.thum .course-teacher .name h6 a',
            ]
        );
        $this->add_control(
            'author_color',
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs('body_box_tabs');
                ...
                $this->add_group_control(
                    ...
                    [
                        'name' => 'box_shadow',
                        'selector' => '{{WRAPPER}} .edubin-single-course, .edubin-single-course-2',
                    ]
                );
                ...
                $this->add_group_control(
                    ...
                    [   'label' => __( 'Box Shadow Hover', 'edubin-core' ),
                        ...
                        'selector' => '{{WRAPPER}} .edubin-single-course:hover, .edubin-single-course-2:hover',
                    ]
                );
