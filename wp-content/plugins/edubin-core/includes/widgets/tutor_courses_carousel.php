...
class Edubin_Elementor_Widget_Tutor_Course_Carousel extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'show_footer',
			[
				'label' => esc_html__('Footer/Price', 'edubin-core'),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_group_control(
			...
			[
				'name' => 'box_shadow',
				'selector' => '{{WRAPPER}} .edubin-tutor-courses-addons .slick-slide',
			]
		);
		...
		$this->add_group_control(
			...
			'selector' => '{{WRAPPER}} .tutor-loop-course-container:hover',
		]
	);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tutor-course-loop-title h2 a',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => Scheme_Typography::TYPOGRAPHY_1,
				'selector' => '{{WRAPPER}} .tutor-loop-author>.tutor-single-course-author-name a',
			]
		);
