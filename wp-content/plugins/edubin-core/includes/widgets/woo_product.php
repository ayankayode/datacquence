...
class Edubin_Elementor_Widget_Woo_Product extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '4',
                'options' => [
                    '3' => __('3 Column', 'edubin-core'),
                    '4' => __('4 Column', 'edubin-core'),
                ],
                'condition'=>[
                    'carousel_on_off!'=> 'yes',
                ]
    ...
    protected function render( $instance = [] ) {
        ...
        // Button style
        $this->add_render_attribute( 'edubin_carousel_btn_style', [ 'class' => 'edubin-nav-button-'.$settings['nav_arrow_style'] ] );
        // Price style
        $this->add_render_attribute( 'edubin_price_style', 'class', 'edubin-course-price-'.'1' );
        // Carusel options
