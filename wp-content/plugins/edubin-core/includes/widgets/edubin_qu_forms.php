...
class Edubin_Elementor_Widget_QUforms extends Widget_Base {

    public function get_name() {
        return 'edubin-quforms-addons';
    }
    
    public function get_title() {
        return __( 'QU Form', 'edubin-core' );
    }
    ...
    public function edubin_quform_list() {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => '0',
                    'options' => $this->edubin_quform_list(),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Sub Label', 'edubin-core' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render( $instance = [] ) {
        ...
        if (!$settings['contact_form_list']) {
            echo '<p>'.__('Please select Contact Form', 'edubin-core').'</p>';
        }else{
            $form_attributes = [
