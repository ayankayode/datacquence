...
class Edubin_Elementor_Widget_Ninja_Form extends Widget_Base {

    public function get_name() {
        return 'edubin-ninjaform-addons';
    }
    
    public function get_title() {
        return __( 'Ninja Form', 'edubin-core' );
    }
    ...
    public function edubin_ninja_forms_list() {
        $form_options = array();
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'ninjaform_content',
            [
                'label' => __( 'Ninja Form', 'edubin-core' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => $this->edubin_ninja_forms_list(),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'show_form_title',
                [
                    'label'                 => __( 'Title Hide', 'edubin-core' ),
            ...
            $this->add_control(
                ...
                [
                    'label'                 => __( 'Description Hide', 'edubin-core' ),
                    'type'                  => Controls_Manager::SWITCHER,
                    'selectors' => [
