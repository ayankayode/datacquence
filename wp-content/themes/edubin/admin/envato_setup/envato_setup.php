                ...
                if ( !$option || empty($option['oauth']) || empty( $option['oauth'][ $this->envato_username ] ) || empty($envato_items) || empty($envato_items['items']) || !envato_market()->items()->themes( 'purchased' )) {
                    ...
                    if ( ! $dissmissed_time || $dissmissed_time < strtotime('-7 days') ) {
                        ...
                        <div class="notice notice-warning notice-dtbwp-themeupdates is-dismissible">
                            ...
                            _e( 'Please activate updates to ensure you have the latest version of this Edubin Theme & Edubin Core plugin.' );
                                ?></p>
                            <p>
                                <?php printf( __( '<a class="button button-primary" href="%s">Activate Updates</a>','edubin' ),  esc_url($this->get_oauth_login_url( admin_url( 'admin.php?page=' . envato_market()->get_slug() . '' ) ) ) ); ?> 

                                <?php printf( __( '<a class="button button-primary" href="%s">Check Theme Update</a>','edubin' ),  esc_url( admin_url( 'themes.php') ) ) ; ?>          

                                <?php printf( __( '<a class="button button-primary" href="%s">Check Edubin Core Update</a>','edubin' ),  esc_url( admin_url( 'plugins.php') ) ) ; ?>
                            </p>
                        </div>
